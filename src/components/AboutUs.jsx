...
const AboutUs = () => {
  return (
    <div className="w-11/12 m-auto flex flex-col md:flex-row justify-between items-center md:space-x-10 space-y-10 md:space-y-0 py-10 font-poppins">
    ...
    <div className="w-11/12 md:w-1/2 space-y-5">
      <h1 className="text-6xl font-bold text-[#716969]">
        Know <span className="text-[#fb8b24]">About us</span>{" "}
      </h1>
      ...
      <button className="px-5 py-2 rounded-md bg-[#fb8b24] hover:bg-[#fb8a34d4] transition-all">
        Read more
      </button>
    </div>
  </div>
